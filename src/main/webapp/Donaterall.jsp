...
<body>
                    ...
                    <section>
                        <nav>
                            <ul>
                                <li>
                                    <button type="button" value="Get All Record"  class="open-button" onclick="openForm()" style="width:70px; height:40px; margin:5px;  border:none;  border-radius:2px;font-size:17px; font-weight:bold;">View</button>
                        ...
                        <article>
                            <h1 style="color:white; font-size: 20px;"> Donater Records</h1>
                            ...
                            %>
                                ...
                                <td  style="background-color:#32cd32  ;" ><a style="color:black ;" type="button" class="button1"  href='Donateredit?id=<%=rs.getString("id")%>'>EDIT</a> 

								</td>
								<td  style="background-color:#ff4500  ;">
                                     <a style="color:black ;" type="button" class="button2"   href='Donaterdelete?id=<%=rs.getString("id")%>' >DELETE</a>
